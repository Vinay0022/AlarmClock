...
def Alarm(set_alarm_timer):
    while True:
        ...
        if cur_time == set_alarm_timer:
            winsound.PlaySound("D:\\alarm_01.wav",winsound.SND_LOOP)
            break
...
time_format=Label(window, text= "Remember to set time in 24 hour format!", fg="white",bg="#922B21",font=("Arial",15)).place(x=10,y=130)
